...
public class Helper {
    ...
    public static final String PUBLIC_FOLDER = "https://supportcenter03.000webhostapp.com/restaurant/public/";
    public static final String PATH_TO_SERVER_LOGIN = PUBLIC_FOLDER + "signin";
    public static final String PATH_TO_SERVER_REGISTRATION = PUBLIC_FOLDER + "signup";
    public static final String PATH_TO_RESET_PASSWORD = PUBLIC_FOLDER + "requestpasswordreset";
